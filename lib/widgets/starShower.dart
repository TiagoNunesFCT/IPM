...
class StarShower extends StatelessWidget {
  ...
  Widget background(BuildContext context) {
    return Row(
      ...
      children: [
        Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30),
        Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30),
        Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30),
        Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30),
        Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30)],
      ...
      case 0:
        {
          ...
          starsW = Row(
            mainAxisSize: MainAxisSize.min,
            children: [Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30), Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30), Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30), Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30), Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30)],
          );
        }
        break;
      case 1:
        {
          ...
          starsW = Row(
            mainAxisSize: MainAxisSize.min,
            children: [Icon(Icons.star_half_rounded, color: Colors.orangeAccent, size: 30), Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30), Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30), Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30), Icon(Icons.star_outline_rounded, color: Colors.white12, size: 30)],
          );
        }
        break;
      case 2:
      ...
      case 10:
        {
          ...
          starsW = Row(
            mainAxisSize: MainAxisSize.min,
            children: [Icon(Icons.star_rounded, color: Colors.orangeAccent, size: 30), Icon(Icons.star_rounded, color: Colors.orangeAccent, size: 30), Icon(Icons.star_rounded, color: Colors.orangeAccent, size: 30), Icon(Icons.star_rounded, color: Colors.orangeAccent, size: 30), Icon(Icons.star_rounded, color: Colors.orangeAccent, size: 30)],
          );
        }
        break;
    }
